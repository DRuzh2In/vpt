...
CREATE TABLE `line` (
  ...
  `count_free_port` int(11) NOT NULL,
  `len_line` int(11) NOT NULL,
  `id_cross` int(11) NOT NULL,
  PRIMARY KEY (`id_line`),
  KEY `line_cross_id_cross_fk` (`id_cross`),
  CONSTRAINT `line_cross_id_cross_fk` FOREIGN KEY (`id_cross`) REFERENCES `cross` (`id_cross`)
